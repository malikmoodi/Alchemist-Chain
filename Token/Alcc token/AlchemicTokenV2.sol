...
contract AlchemicTokenV2 is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address cOwner, address treasuryWallet, address miscWallet , address _operator) initializer public {
        __ERC20_init("Alchemic Token V2", "$ALCC");
        __Pausable_init();
        __Ownable_init();
    ...
    function withdrawToken(address token, address _beneficiary, uint256 _amount) public onlyOwner{
